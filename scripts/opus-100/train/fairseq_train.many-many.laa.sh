...
project_dir=/home/hnc/PycharmProjects/nmt-multi
...
tensorboard_logdir=${project_dir}/data/opus-100-corpus/many-many.laa/tensorboard_logdir
...
cd $project_dir/fairseq_dir

python train.py ${main_data_bin_dir} \
    --user-dir ${project_dir}/nmt/user_dir \
    --task translation_multi_simple_epoch_enable_lang_id \
    --arch transformer_laa \
    --enable-tgt-lang-ids \
